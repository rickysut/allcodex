...
class KabupatenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $table->addColumn('kd_prop_kd_prop', function ($row) {
                return $row->kd_prop ? $row->kd_prop->kd_prop : '';
            });
            ...
            $table->editColumn('tz', function ($row) {
                return $row->tz ? $row->tz : '';
            });
    ...
    public function create()
    {
        ...
        $kd_props = Provinsi::pluck('kd_prop', 'id')->prepend(trans('global.pleaseSelect'), '');
