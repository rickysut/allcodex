...
class DataRealisasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.dataRealisasis.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.dataRealisasis.create');
    }
    ...
    public function edit(DataRealisasi $dataRealisasi)
    {
        ...
        return view('admin.dataRealisasis.edit', compact('dataRealisasi'));
    }
    ...
    public function show(DataRealisasi $dataRealisasi)
    {
        ...
        return view('admin.dataRealisasis.show', compact('dataRealisasi'));
    }
