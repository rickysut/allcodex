...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.dataRealisasi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.data-realisasis.update", [$dataRealisasi->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="kdsatker">{{ trans('cruds.dataRealisasi.fields.kdsatker') }}</label>
                <input class="form-control {{ $errors->has('kdsatker') ? 'is-invalid' : '' }}" type="text" name="kdsatker" id="kdsatker" value="{{ old('kdsatker', $dataRealisasi->kdsatker) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ba') ? 'is-invalid' : '' }}" type="text" name="ba" id="ba" value="{{ old('ba', $dataRealisasi->ba) }}">
                @if($errors->has('ba'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ba') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('baes_1') ? 'is-invalid' : '' }}" type="text" name="baes_1" id="baes_1" value="{{ old('baes_1', $dataRealisasi->baes_1) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akun') ? 'is-invalid' : '' }}" type="text" name="akun" id="akun" value="{{ old('akun', $dataRealisasi->akun) }}">
                @if($errors->has('akun'))
                    <div class="invalid-feedback">
                        {{ $errors->first('akun') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('program') ? 'is-invalid' : '' }}" type="text" name="program" id="program" value="{{ old('program', $dataRealisasi->program) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kegiatan') ? 'is-invalid' : '' }}" type="text" name="kegiatan" id="kegiatan" value="{{ old('kegiatan', $dataRealisasi->kegiatan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('output') ? 'is-invalid' : '' }}" type="text" name="output" id="output" value="{{ old('output', $dataRealisasi->output) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kewenangan') ? 'is-invalid' : '' }}" type="text" name="kewenangan" id="kewenangan" value="{{ old('kewenangan', $dataRealisasi->kewenangan) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sumber_dana') ? 'is-invalid' : '' }}" type="text" name="sumber_dana" id="sumber_dana" value="{{ old('sumber_dana', $dataRealisasi->sumber_dana) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cara_tarik') ? 'is-invalid' : '' }}" type="text" name="cara_tarik" id="cara_tarik" value="{{ old('cara_tarik', $dataRealisasi->cara_tarik) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kdregister') ? 'is-invalid' : '' }}" type="text" name="kdregister" id="kdregister" value="{{ old('kdregister', $dataRealisasi->kdregister) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lokasi') ? 'is-invalid' : '' }}" type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $dataRealisasi->lokasi) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_type') ? 'is-invalid' : '' }}" type="text" name="budget_type" id="budget_type" value="{{ old('budget_type', $dataRealisasi->budget_type) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal') ? 'is-invalid' : '' }}" type="text" name="tanggal" id="tanggal" value="{{ old('tanggal', $dataRealisasi->tanggal) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="text" name="amount" id="amount" value="{{ old('amount', $dataRealisasi->amount) }}">
